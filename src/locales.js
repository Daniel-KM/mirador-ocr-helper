export default {
  de: {
    ...
    panelVisible: 'OCR-Panel anzeigen/verbergen',
    ...
    ocrHelperShowOverlay: 'Texteditor anzeigen',
    ocrHelperHideOverlay: 'Texteditor verbergen',
...
`,
  ...
  fr: {
    ...
    ocrHelperShowOverlay: 'Afficher les outils de texte',
    ocrHelperHideOverlay: 'Masquer les outils de texte',
    ...
    panelVisible: 'Afficher/cacher le panneau OCR',
...
`,
  ...
  it: {
    ...
    panelVisible: 'Mostra/nascondi pannello OCR',
    ...
    ocrHelperShowOverlay: 'Mostra strumenti di testo',
    ocrHelperHideOverlay: 'Nascondi strumenti di testo',
...
`,
  ...
  en: {
    ...
    panelVisible: 'Show/hide OCR panel',
    ...
    ocrHelperShowOverlay: 'Show text tools',
    ocrHelperHideOverlay: 'Hide text tools',
